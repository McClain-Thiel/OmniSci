 ...
 * owned by the web layer. This fills its center with "OmniSci — <host>" and
 ...
 *
 * When a thread is open, its title replaces the "OmniSci" brand label
...
export function TitleBarServerPicker({
  ...
  /** Title of the currently open thread, or null/undefined when no thread
      is selected or it has no title yet (falls back to "OmniSci"). */
      ...
      <DropdownMenu>
        ...
        >
          <span className="truncate font-medium">
            {threadTitle || "OmniSci"} — {hostOf(info.currentOrigin)}
          </span>
